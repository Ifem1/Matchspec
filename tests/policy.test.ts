...
describe('genlayer-js 1.1.8 receipt gate', () => {
  ...
  it('recognizes the snake-case undetermined result used by the live receipt path', () => expect(isAcceptedReceipt({status_name: 'UNDETERMINED', result_name: 'UNDETERMINED', tx_execution_result_name: 'FINISHED_WITH_RETURN'})).toBe(false));
